...
(function () {
                    ...
                    if (type == 'css') {
                        if (!uaCssChecked) {
                            ...
                            if (/iP(hone|od|ad)/.test(navigator.platform)) {
                                ...
                                if (ua.indexOf("android") > -1) { // Android < 4.4
                    ...
                    var pushFile = function (path) {
                        ...
                        if (angular.isUndefined(cachePromise) || params.cache === false) {
                            if (/\.(css|less)[^\.]*$/.test(path) && cssFiles.indexOf(path) === -1) {
                                ...
                                if (/\.(htm|html)[^\.]*$/.test(path) && templatesFiles.indexOf(path) === -1) {
    ...
    function getModuleName(module)
    {
        ...
        if (angular.isString(module)) {
            ...
            if (angular.isObject(module) && module.hasOwnProperty('name') && angular.isString(module.name)) {
