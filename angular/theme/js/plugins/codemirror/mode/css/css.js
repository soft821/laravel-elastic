    ...
    CodeMirror.defineMode("css", function (config, parserConfig) {
                                ...
                                if (/\d/.test(ch) || ch == "." && stream.eat(/\d/)) {
                                    ...
                                    if (ch === "-") {
                                        ...
                                        if (/[,+>*\/]/.test(ch)) {
                                            ...
                                            if (ch == "." && stream.match(/^-?[_a-z][_a-z0-9-]*/i)) {
                                                return ret("qualifier", "qualifier");
                                            } else
                                                if (/[:;{}\[\]\(\)]/.test(ch)) {
                                                    return ret(null, ch);
                                                } else
                                                    if (ch == "u" && stream.match("rl(")) {
                                                        stream.backUp(1);
        ...
        function wordAsValue(stream)
        {
            ...
            if (valueKeywords.hasOwnProperty(word))
                ...
                if (colorKeywords.hasOwnProperty(word))
                    override = "keyword";
                else
                    override = "variable";
        }
            ...
            if (type == "word") {
                ...
                if (word == "only" || word == "not" || word == "and")
                    ...
                    if (mediaTypes.hasOwnProperty(word))
                        ...
                        if (mediaFeatures.hasOwnProperty(word))
                            override = "property";
                        else
                            override = "error";
            }
