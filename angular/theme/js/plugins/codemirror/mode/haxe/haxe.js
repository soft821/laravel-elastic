    ...
    CodeMirror.defineMode("haxe", function (config, parserConfig) {
                ...
                if (/[\[\]{}\(\),;\:\.]/.test(ch))
                    ...
                    if (ch == "0" && stream.eat(/x/i)) {
                        ...
                        if (/\d/.test(ch) || ch == "-" && stream.eat(/\d/)) {
                            ...
                            if (state.reAllowed && (ch == "~" && stream.eat(/\//))) {
        ...
        function typedef(type, value)
        {
            if (type == "variable" && /[A-Z]/.test(value.charAt(0))) {
                ...
                if (type == "type" && /[A-Z]/.test(value.charAt(0))) {
                    return cont();
                }
        }
        ...
        return {
            ...
            indent: function (state, textAfter) {
                ...
                if (type == "vardef") return lexical.indented + 4;
                    ...
                    if (type == "form" && firstChar == "{") return lexical.indented;
                    else
                        if (type == "stat" || type == "form") return lexical.indented + indentUnit;
                        else
