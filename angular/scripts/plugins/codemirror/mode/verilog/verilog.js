        ...
        return {
                        ...
                        if (curPunc == "{") {
                            ...
                            if (curPunc == "[") {
                                ...
                                if (curPunc == "(") {
                                    ...
                                    if (ctx && ctx.type == "endcase" && curPunc == ":") {
                                        ...
                                        if (curPunc == "newstatement") {
                                            ...
                                            if (curPunc == "newblock") {
                                                if (curKeyword == "function" && ctx && (ctx.type == "statement" || ctx.type == "endgroup")) {
                                                    ...
                                                    if (curKeyword == "task" && ctx && ctx.type == "statement") {
                                                        // Same thing for task
                                                    } else {
            ...
            indent: function (state, textAfter) {
                ...
                if (ctx.type == "statement") return ctx.indented + (firstChar == "{" ? 0 : statementIndentUnit);
                    ...
                    if (closingBracket.test(ctx.type) && ctx.align && !dontAlignCalls) return ctx.column + (closing ? 0 : 1);
                    else
