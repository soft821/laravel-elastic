    ...
    var Attr2MapOptions = function (
        ...
        var getLatLng = function (input) {
            ...
            if (input[0].constructor == Array) {
                ...
                if (!isNaN(parseFloat(input[0])) && isFinite(input[0])) {
                        ...
                        if (input.match(/^([A-Z][a-zA-Z0-9]+)\.([A-Z]+)$/)) {
                            ...
                            if (input.match(/^[A-Z]+$/)) {
                                ...
                                if (input.match(isoDateRE)) {
                                    ...
                                    if (input.match(new RegExp('^' + escapeRegExp(exprStartSymbol))) && options.scope) {
                                        try {
            ...
            for (var key in attrs) {
                if (attrs[key] || attrs[key] === 0) {
                    if (key.match(/^on[A-Z]/)) { //skip events, i.e. on-click
                        ...
                        if (key.match(/ControlOptions$/)) { // skip controlOptions
                            continue;
                        } else {
