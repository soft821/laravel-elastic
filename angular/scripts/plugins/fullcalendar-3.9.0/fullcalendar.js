                    ...
                    for (propName in rawProps) {
                        if (EventDateProfile_1.default.isStandardProp(propName)) {
                            ...
                            if (eventDef.isStandardProp(propName)) {
                                ...
                                if (eventDef.miscProps[propName] !== rawProps[propName]) {
                ...
                View.prototype.computeTitleFormat = function (dateProfile) {
                    ...
                    if (currentRangeUnit === 'year') {
                        ...
                        if (currentRangeUnit === 'month') {
                            ...
                            if (dateProfile.currentUnzonedRange.as('days') > 1) {
            ...
            var DayTableMixin = /** @class */ (function (_super) {
                ...
                DayTableMixin.prototype.getDateDayIndex = function (date) {
                    ...
                    if (dayOffset < 0) {
                        ...
                        if (dayOffset >= dayIndices.length) {
    ...
    ------------------------------------------------------------------------------------------------------------------*/
                ...
                DayTableMixin.prototype.renderHeadDateCellHtml = function (date, colspan, otherAttrs) {
                    ...
                    if (typeof t.opt('columnHeaderHtml') === 'function') {
                        ...
                        if (typeof t.opt('columnHeaderText') === 'function') {
                ...
                ParsableModelMixin.prototype.applyProps = function (rawProps) {
                    ...
                    for (propName in rawProps) {
                        if (standardPropMap[propName] === true) {
                            ...
                            if (standardPropMap[propName] === false) {
            ...
            var BusinessHourGenerator = /** @class */ (function () {
                ...
                BusinessHourGenerator.prototype.buildEventDefs = function (isAllDay) {
                    ...
                    if (rawComplexDef === true) {
                        ...
                        if ($.isPlainObject(rawComplexDef)) {
                            rawDefs = [rawComplexDef];
                        }
                        else
                            if ($.isArray(rawComplexDef)) {
                                rawDefs = rawComplexDef;
            ...
            var Calendar = /** @class */ (function () {
                ...
                Calendar.prototype._calcSize = function () {
                    ...
                    if (typeof contentHeightInput === 'number') {
                        ...
                        if (typeof contentHeightInput === 'function') {
                            this.suggestedViewHeight = contentHeightInput();
                        }
                        else
                            if (typeof heightInput === 'number') {
                                ...
                                if (typeof heightInput === 'function') {
                                    this.suggestedViewHeight = heightInput() - this.queryToolbarsHeight();
                                }
                                else
                                    if (heightInput === 'parent') {
    ...
    ------------------------------------------------------------------------------------------------------------------*/
                ...
                DateProfileGenerator.prototype.buildCurrentRangeInfo = function (date, direction) {
                    ...
                    if (viewSpec.duration) {
                        ...
                        if ((dayCount = this.opt('dayCount'))) {
                            unit = 'day';
                            unzonedRange = this.buildRangeFromDayCount(date, direction, dayCount);
                        }
                        else
                            if ((unzonedRange = this.buildCustomVisibleRange(date))) {
                ...
                DateProfileGenerator.prototype.buildDateIncrement = function (fallback) {
                    ...
                    if (dateIncrementInput) {
                        ...
                        if ((customAlignment = this.opt('dateAlignment'))) {
    ...
    */
                ...
                EventDragging.prototype.handleTouchStart = function (seg, ev) {
                    ...
                    if (component.canStartDrag(seg, ev)) {
                        ...
                        if (component.canStartSelection(seg, ev)) {
                            ...
                            $.each(buttonGroupStr.split(','), function (j, buttonName) {
                                ...
                                if (buttonName === 'title') {
                                    ...
                                    if ((customButtonProps = calendarCustomButtons[buttonName])) {
                                        ...
                                        if ((viewSpec = viewSpecManager.getViewSpec(buttonName))) {
                ...
                OptionsManager.prototype.add = function (newOptionHash) {
                    ...
                    if (optionCnt === 1) {
                        if (optionName === 'height' || optionName === 'contentHeight' || optionName === 'aspectRatio') {
                            ...
                            if (optionName === 'defaultDate') {
                                return; // can't change date this way. use gotoDate instead
                            }
                            else
                                if (optionName === 'businessHours') {
                                    return; // this model already reacts to this
                                }
                                else
                                    if (/^(event|select)(Overlap|Constraint|Allow)$/.test(optionName)) {
                                        return; // doesn't affect rendering. only interactions.
                                    }
                                    else
                                        if (optionName === 'timezone') {
